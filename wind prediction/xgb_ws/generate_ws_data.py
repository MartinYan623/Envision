...
from plot_util.plot_revised_ws import plot_revised_wind_std
import pickle
logger = logging.getLogger(__name__)


def generate_turbine_ws_data(model, test_data_path, feature_file_path, evaluation_periods=list(range(16, 41)),
...
def generate_farm_ws_data_local(model_path, test_data_path, feature_path, evaluate_frequency):
...
if __name__ == '__main__':
    ...
    generate_farm_ws_data_local(model_path, test_data_path, feature_path, evaluate_frequency)
